...
import sidearr from "../../src/asset/keyboard_arrow_right.svg"
...
import TextInput from "../component/atoms/Input"
const Invoice = () => {
	...
	return (
		<Layout>
			<div className='flex'>
				<div className='w-3/4 h-screen mb-20 ml-10'>
					<div className=' flex gap-2 items-center'>
						<span className='flex items-center gap-1 text-[#2563EB] text-base '>
							<img width='30' height='20' src={invoice} alt='user' />
							Invoice
						</span>
						<img width='30' height='20' src={sidearr} alt='rightarr' />
					...
					<div className=' my-10'>
						<p className='text-2xl mb-2 font-semibold text-[#000000]'>
							Invoice Details
						</p>

						<p className='text-sm tracking-tight text-[#475569]'>
					...
					<form onSubmit={handleSubmit} className='w-full'>
						...
						<div className='mt-4'>
							<textarea
								...
								className='w-full border border-[#CBD5E1] rounded-md py-4 px-4 focus:outline-none focus:ring-2 focus:ring-blue-400 bg-[#F8FAFC]'></textarea>
						</div>
						...
						<div className='w-full overflow-x-auto'>
							<table className='min-w-full mt-5 w-full divide-y divide-gray-200 table-fixed'>
										...
										<tr key={item.id}>
											<td className='px-6 py-4 whitespace-nowrap'>
												<input
													...
													className='bg-[#F8FAFC] px-4 w-full py-4 border border-gray-300 rounded focus:outline-none focus:ring focus:border-blue-500'
												/>
											</td>
											<td className='px-6 py-4 whitespace-nowrap'>
												<input
							...
							<div className='mb-4'>
								<div className='relative'>
									<textarea
										...
										className='bg-[#F8FAFC]  w-full h-32 px-4 py-5  border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-500'></textarea>
								</div>
							</div>
							<label
				...
				<CheckedButtons className='w-1/4' />
			</div>
			<Footer />
		</Layout>
	)
